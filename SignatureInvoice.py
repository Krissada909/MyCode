...
# กำหนดชื่อไฟล์
output_filename = f"Invoice_(สำเนา){timestamp}.pdf"
...
if username == "sa":
    ...
    add_image_to_pdf(r"\\N2N-BANK\Users\Administrator\Downloads\Excel\Invoice\Test.pdf", "Ting Digital Sign.png", output_path)
    # เปิดโฟลเดอร์
    os.startfile(path)

elif username == "ken":
    print("Username is bank")
    add_image_to_pdf(r"\\N2N-BANK\Users\Administrator\Downloads\Excel\Invoice\Test.pdf", "Ken-Signature.png", output_path)
    # เปิดโฟลเดอร์
    os.startfile(path)